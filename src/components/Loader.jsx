...
const Loader = ({ onFinish }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-black font-comic">
      <div className="border-[3.5px] border-black p-8 w-[90%] max-w-5xl rounded-3xl shadow-[4px_4px_0_0_black] bg-white flex flex-col items-center gap-8">
        <AnimatePresence mode="wait">
          <motion.p
            ...
            className="text-2xl -mb-2 tracking-wide absolute"
          >
            {currentMessage}
          </motion.p>
        </AnimatePresence>
        <div className="text-2xl -mb-2 tracking-wide opacity-0 pointer-events-none">
        ...
        <div className="w-full h-[85px] relative overflow-hidden">
          ...
          <img
            ...
            src={Pencil}
            alt="pencil"
            className="w-8 h-20 absolute top-0 left-0 z-20 object-contain pointer-events-none"
          />
        </div>
      </div>
    </div>
